nano x.pem (key save..) 
openssl rsautl -decrypt -inkey x.pem -in flag.enc(if enc file dey) ~ run found flag
...
[Diffie-Hellman](https://book.jorianwoltjer.com/cryptography/asymmetric-encryption/diffie-hellman)
